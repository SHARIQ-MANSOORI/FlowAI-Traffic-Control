            ...
            <AnimatePresence>
              {isAmbulanceActive && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  className="bg-red-500/10 border border-red-500 text-red-400 px-4 py-2 rounded-lg flex items-center gap-3 font-bold font-mono shadow-[0_0_20px_rgba(239,68,68,0.3)]"
                >
              ...
              {isManualEmergency && (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  exit={{ opacity: 0, x: 20 }}
                  className="bg-destructive/10 border border-destructive text-destructive px-4 py-2 rounded-lg flex items-center gap-3 font-bold font-mono animate-pulse shadow-[0_0_20px_rgba(255,50,50,0.3)]"
                >
